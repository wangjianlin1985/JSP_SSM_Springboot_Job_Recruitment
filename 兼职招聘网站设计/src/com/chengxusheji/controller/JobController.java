...
public class JobController extends BaseController {
	...
	public void companyAdd(Job job, BindingResult br,
		...
		String companyUserName = session.getAttribute("company").toString();
		Company companyObj = new Company();
		companyObj.setCompanyUserName(companyUserName);
		job.setCompanyObj(companyObj);
		
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		job.setAddTime(sdf.format(new java.util.Date()));
	...
	public String frontshow(@PathVariable Integer jobId,Model model,HttpServletRequest request) throws Exception {
        ...
        job.setViewNum(job.getViewNum() + 1);
