	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="userInfoQueryForm" id="userInfoQueryForm" action="<%=basePath %>UserInfo/frontlist" class="mar_t15">
			...
			<div class="form-group">
				...
				<input type="text" id="xl" name="xl" value="<%=xl %>" class="form-control" placeholder="请输入学历">
			</div>
			<div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_xl_edit" name="userInfo.xl" class="form-control" placeholder="请输入学历">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			    <a id="userInfo_jianliFileA" target="_blank"></a><br/>
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			    <a id="userInfo_smrzzlA" target="_blank"></a><br/>
