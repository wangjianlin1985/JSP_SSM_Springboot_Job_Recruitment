...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">大学生兼职网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Job/frontlist">职位搜索</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>UserInfo/userInfo_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;求职注册</a></li>
	  			<li><a href="<%=basePath %>Company/company_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;企业注册</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>Delivery/userFrontlist"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我投递的职位</a></li>
                        <li><a href="<%=basePath %>JobRecord/jobRecord_userFrontAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布兼职记录</a></li>
                        <li><a href="<%=basePath %>JobRecord/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的兼职记录</a></li>
                        <li><a href="<%=basePath %>Leaveword/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的网站留言</a></li>
