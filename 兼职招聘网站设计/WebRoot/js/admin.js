		       ...
		       text: "职位管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "JobType/jobType_add.jsp"
			    	   	},
			    		{
			    	   		text: "职位类别管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "JobType/jobType_query_result.jsp"
			    	    },
			    	    {
			    		    text: "添加职位",
			    		    state: "open",
		       ...
		       text: "简历投递管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Delivery/delivery_add.jsp"
			    	   	},
			    		{
			    	   		text: "简历投递管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Delivery/delivery_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "兼职记录管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "JobRecord/jobRecord_add.jsp"
			    	   	},
			    		{
			    	   		text: "兼职记录管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "JobRecord/jobRecord_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "留言管理",
